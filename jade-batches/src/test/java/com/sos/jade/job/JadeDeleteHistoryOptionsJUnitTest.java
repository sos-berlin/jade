...
/** \class JadeDeleteHistoryOptionsJUnitTest - Delete entries in Jade history
 * table
 *
 * \brief
 *
 ...
 * ("		JadeDeleteHistoryOptionsJUnitTest.auth_file", "test"); // This parameter
