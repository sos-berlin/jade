...
/** \class SOSJadeHistoryOptionsSuperClass - Import from order or file to
 * JadeHistoryTable
 *
 * \brief An Options-Super-Class with all Options. This Class will be extended
 * by the "real" Options-class (\see SOSJadeHistoryOptions. The "real" Option
 ...
 * Einstellungen\Temp\scheduler_editor-8747611472807146950.html for (more)
 * details.
 * 
 ...
 * 20120117145957 \endverbatim \section OptionsTable Tabelle der vorhandenen
 * Optionen
 * 
 ...
 * ("		SOSJadeHistoryOptionsSuperClass.auth_file", "test"); // This parameter
