...
/** \class SOSJadeHistoryJSAdapterClass - JobScheduler Adapter for
 * "Import from order or file to JadeHistoryTable"
 *
 * \brief AdapterClass of SOSJadeHistory for the SOSJobScheduler
 *
 * This Class SOSJadeHistoryJSAdapterClass works as an adapter-class between the
 * SOS JobScheduler and the worker-class SOSJadeHistory.
 *
 * 
 *
 * see \see C:\Dokumente und Einstellungen\Uwe Risse\Lokale
 * Einstellungen\Temp\scheduler_editor-200438664770970222.html for more details.
 *
