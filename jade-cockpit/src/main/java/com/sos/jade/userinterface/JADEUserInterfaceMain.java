...
public class JADEUserInterfaceMain extends ApplicationWindow {
	 ...
	 */
	@SuppressWarnings("deprecation") public JADEUserInterfaceMain() {
		super(null);
	...
	@Override protected Control createContents(final Composite parent) {
		...
		Globals.stColorRegistry.put("FieldBackGround", new RGB(220,249,0));  //   var. 1 = #DCF900 = rgb(220,249,0)
		Globals.stColorRegistry.put("Color4FieldHasFocus", new RGB(124,231,0));  //    var. 1 = #7CE700 = rgb(124,231,0)
		Globals.stColorRegistry.put("Color4FieldInError", new RGB(255,225,0));  //  var. 1 = #FFE100 = rgb(255,225,0)
		
//		Globals.stColorRegistry.put("CompositeBackGround", new RGB(236,252,113));  //     var. 5 = #ECFC71 = rgb(236,252,113)
//		   var. 5 = #FFFFB0 = rgb(255,255,176)
		...
		}
		{
			...
			sashForm.setLayoutData(gd_sashForm);
			{
				...
				tree.setBackground(Globals.stColorRegistry.get("CompositeBackGround"));
				...
				menuMgr.addMenuListener(new IMenuListener() {
					@Override public void menuAboutToShow(final IMenuManager manager) {
						...
						if (treeViewer.getSelection() instanceof ISelection) {
							...
							Object item = selection.getFirstElement();
							if (item instanceof JadeTreeViewEntry) {
								@SuppressWarnings("unused") JadeTreeViewEntry objSelectedSection1 = (JadeTreeViewEntry) item;
								String strCaption = ((JadeTreeViewEntry) item).getTitle();
								...
								actBrowseSource.setImageDescriptor(getImage("BrowseSource.gif"));
...
//		return ImageDescriptor.createFromImage(SWTResourceManager.getImage(pstrFileName));
	...
	private SectionsHandler initializeSession() {
		...
		//		SectionsHandler objSections = new SectionsHandler(root, session.getName());
...
//				tbtmProfileTab.setData("composite", composite);
	...
	//	private LogFileComposite createLogFileFolder(final JadeTreeViewEntry objS) {
...
//		statusLineManager.getControl().setBackground(Globals.getCompositeBackground());
	...
	//		ImageDescriptor folderImg = PlatformUI.getWorkbench().getSharedImages().getImageDescriptor(strSymbolicName /* ISharedImages.IMG_OBJ_FOLDER */);
	//		return folderImg;
	//	}
	//
	...
	//		MessageDialog.openInformation(win.getShell(), "Jade -Information-", pstrMsgText);
	//	}
	//	private ImageDescriptor getImage(final String pstrImageFileName) {
	//
	//		ImageDescriptor image = AbstractUIPlugin.imageDescriptorFromPlugin("com.sos.jade.userinterface", "icons/" + pstrImageFileName);
	//
	//		return image;
	//	}
