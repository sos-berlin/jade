...
/**
 * <p>Java-Klasse für ListableFragmentRefType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="ListableFragmentRefType">
 *   &lt;complexContent>
...
@XmlType(name = "ListableFragmentRefType", propOrder = {
    "ftpFragmentRef",
    "ftpsFragmentRef",
    "localSource",
    "sftpFragmentRef",
...
@XmlSeeAlso({
    AlternativeGetListSourceFragmentRef.class
})
public class ListableFragmentRefType {
