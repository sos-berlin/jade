...
public class JadeFilesHistoryContainer extends IndexedContainer {
    ...
    private void addContainerProperties() {
        ...
        addContainerProperty(JadeHistoryFileColumns.TRANSFER_TIMESTAMP.getName(), JadeHistoryFileColumns.TRANSFER_TIMESTAMP.getType(), JadeHistoryFileColumns.TRANSFER_TIMESTAMP.getDefaultValue());
